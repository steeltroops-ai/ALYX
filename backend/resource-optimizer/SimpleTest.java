...
import com.alyx.resourceoptimizer.service.TestResourceOptimizerService;
...
public class SimpleTest {
    ...
    public static void main(String[] args) {
        System.out.println("Running backend services functionality tests...");
        ...
        try {
            ...
            System.out.println("Backend services are functional and working correctly.");
    ...
    private static void testBasicResourceOptimization() {
        ...
        TestResourceOptimizerService service = new TestResourceOptimizerService();
